...
import static com.midas.outflearn.util.DateTimeUtils.*;
...
public class LectureJdbcRepository implements LectureRepository {
	...
	public Lecture insert(Lecture lecture) {
		...
		jdbcTemplate.update(
			"INSERT INTO lectures (name, lecturer, price, thumbnail_image_url, created_at, updated_at)" +
	...
	public Lecture update(Lecture lecture) {
		int update = jdbcTemplate.update(
			"UPDATE lectures SET name = :name, lecturer = :lecturer, price = :price, thumbnail_image_url = :thumbnailImageUrl, updated_at = :updatedAt"
				+
